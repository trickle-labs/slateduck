...
use rocklake_catalog::partition::{CatalogRegistry, DatasetEntry, PartitionedWriter};
use rocklake_catalog::performance::{
...
fn benchmark_report_serialization() {
    use rocklake_catalog::performance::{BenchmarkMeasurement, BenchmarkReport, ComparisonEntry};
