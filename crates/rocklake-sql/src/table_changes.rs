...
/// Return the current value of the `rocklake_cdc_record_count_mismatch_total` counter.
...
/// `rocklake_cdc_record_count_mismatch_total` counter is incremented.
    ...
    if let Some(expected) = expected_record_count {
        ...
        if actual != expected {
            ...
            tracing::warn!(
                ...
                counter = "rocklake_cdc_record_count_mismatch_total",
