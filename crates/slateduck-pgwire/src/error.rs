...
pub enum SlateDuckError {
    ...
    SqlDispatch(#[from] slateduck_sql::SqlDispatchError),
...
impl From<SlateDuckError> for PgWireError {
    fn from(e: SlateDuckError) -> PgWireError {
